...
> [!NOTE]
> **分支特别说明：** 本项目是从原始的 [FSoft-AI4Code/CodeWiki](https://github.com/FSoft-AI4Code/CodeWiki) fork 而来的增强版本。  
> 我们引入了包括无视上下文窗口的 **Agent 执行模式**、**多路并行生成**、**多语言文档自动翻译及无缝动态切换**以及对 **Golang** 的解析支持。详见下方的 [✨ 本分支的新增特性](#-本分支的新增特性)。
...
相较于上游原始项目，此 fork 重点增强了文档生成的速度、灵活性和国际化表现：
